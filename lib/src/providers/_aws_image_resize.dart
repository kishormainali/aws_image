...
class AwsResizeImage extends ImageProvider<_SizeAwareCacheKey> {
  const AwsResizeImage(
    this.imageProvider, {
  ...
  /// [AwsResizeImage] will compress the image to a size
  ...
  /// It's AwsResizeImage's first pick.
  ...
  /// Composes the `provider` in a [AwsResizeImage] only when `cacheWidth` and
  ...
  ImageStreamCompleter loadImage(
    ...
    Future<Codec> decodeResize(
      ...
      assert(
        getTargetSize == null,
        'AwsResizeImage cannot be composed with another ImageProvider that applies '
  ...
  bool operator ==(Object other) {
    ...
    return other is AwsResizeImage &&
